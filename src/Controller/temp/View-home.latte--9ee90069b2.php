...
/** source: /home/fabianmaiwald/PhpstormProjects/EventPage/src/Controller/../View/home.latte */
final class Template9ee90069b2 extends Latte\Runtime\Template
{
	public const Source = '/home/fabianmaiwald/PhpstormProjects/EventPage/src/Controller/../View/home.latte';
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['old' => '62', 'registration' => '72'], $this->params) as $ʟ_v => $ʟ_l) {
...
';
		foreach ($allEvents as $old) /* line 62 */ {
			echo '        <span>
            Name: ';
			echo LR\Filters::escapeHtmlText($old['name']) /* line 64 */;
			echo ' <br>
            Datum: ';
			echo LR\Filters::escapeHtmlText($old['date']) /* line 65 */;
			echo ' <br>
            Beschreibung: ';
			echo LR\Filters::escapeHtmlText($old['description']) /* line 66 */;
			echo ' <br>
            Maximale Anzahl: ';
			echo LR\Filters::escapeHtmlText($old['max']) /* line 67 */;
			echo ' <br><br>
        </span>
';
...
';
		foreach ($allEvents as $registration) /* line 72 */ {
			echo '        <h4> ';
...
';
			if ($registration['isMax'] < $registration['max']) /* line 75 */ {
				...
				echo LR\Filters::escapeHtmlAttr($registration['eventId']) /* line 77 */;
